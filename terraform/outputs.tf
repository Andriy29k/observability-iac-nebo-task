...
output "vm_public_ip" {
  value = azurerm_public_ip.observability-task-public-ip.ip_address
}

output "ssh_to_vm" {
  value = "ssh ${var.admin_username}@${azurerm_public_ip.observability-task-public-ip.ip_address} -i ${var.ssh_key_path}"
}
